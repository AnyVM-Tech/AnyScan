...
impl Default for ScanConfig {
    fn default() -> Self {
        Self {
            ...
            max_parallel_paths_per_target: 16,
            probe_max_concurrent_requests_per_host: 16,
            deep_max_concurrent_requests_per_host: 16,
            max_concurrent_requests_per_host: 16,
...
const BUILD_ARTIFACT_PATHS: &[&str] = &[
    "/.next/BUILD_ID",
    ...
    "/build/static/js/",
    "/build/static/manifest.webmanifest",
    "/.parcel-cache/",
    "/.turbo/",
    "/vite.config.js.map",
    "/.vite/manifest.json",
...
fn path_profile_paths(profile: &str) -> Option<&'static [&'static str]> {
    match profile {
        ...
        "build-artifacts" => Some(BUILD_ARTIFACT_PATHS),
